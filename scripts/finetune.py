...
class TrainingConfig:
    ...
    output_dir: str = "models/mistralfluence-7b-lora"
    ...
    # W&B config
    wandb_project: str = "mistralfluence-finetune"
...
def main():
    ...
    print("=" * 60)
    print("MistralFluence Fine-Tuning - Phase 2B")
    print("=" * 60)
